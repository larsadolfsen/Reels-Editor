...
- [ ] Text Box component — backend + frontend (Tasks 1-11) done and merged; remaining: CLAUDE.md inventory update (Task 12) and end-to-end export verification + finish branch (Task 13, needs ffmpeg on PATH to test the burned-in export), see [2026-07-17-text-box-design.md](specs/2026-07-17-text-box-design.md) and [2026-07-17-text-box.md](plans/2026-07-17-text-box.md)
