...
- [ ] **Phase 1 — Text Box finish** — [depth doc](specs/2026-07-17-phase-1-text-box-finish-design.md): finish the existing plan's Tasks 12-13 (docs + verification), plus a new drag-to-reposition subthread
