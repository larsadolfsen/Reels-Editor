...
- [ ] **Phase 1 — Text Box finish** — [depth doc](specs/2026-07-17-phase-1-text-box-finish-design.md): Task 13 (verification) done, found+fixed two real export bugs along the way (see Done below); remaining: Task 12 (`CLAUDE.md` docs, a prior dispatch for it was stopped mid-way) and the new drag-to-reposition subthread (needs its own brainstorm)
- [ ] **Phase 2 — Text panel accordion restructure** — [depth doc](specs/2026-07-17-phase-2-accordion-restructure-design.md): six accordions (FONT/STYLE/BOX/POSITION/TIME + highlight), saved presets, inline stage text editing
- [ ] **Phase 3 — Captions** — [depth doc](specs/2026-07-17-phase-3-captions-design.md): real transcription-backed captions reusing Phase 2's accordions, caption list subpanel, karaoke highlight modes
