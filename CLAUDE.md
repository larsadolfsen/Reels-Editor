...
static/
  ...
  preview-text.js        # window.PreviewText: stage text-block overlay rendering (renderText) + selection state (selectedTextBlockId/editingBlockId/editingDiv/boxResizeCallbacks/onStageTextActivate/activeFormatSelection/fitCache) — extracted from preview.js 2026-07-21, pure move
  ...
  panel-text.js           # TEXT context-panel section: FONT/STYLES/BOX/TIME accordion orchestration + stage resize/move handlers (extracted from editor.js 2026-07-21)
